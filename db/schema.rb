...
ActiveRecord::Schema.define(version: 2021_02_02_004005) do
  ...
  create_table "user_round_actions", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "round_id"
    t.string "type"
    t.datetime "time"
    t.jsonb "data"
    t.index ["round_id"], name: "index_user_round_actions_on_round_id"
    t.index ["user_id"], name: "index_user_round_actions_on_user_id"
  end
  ...
  add_foreign_key "user_round_actions", "rounds"
  add_foreign_key "user_round_actions", "users"
end
